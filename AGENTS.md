...
Toda decisión de arquitectura/diseño está en `docs/adr/` (ADR-000 a ADR-023, bilingües).
...
decisions live in `docs/adr/` (ADR-000 to ADR-023, bilingual). Read the ADR before
