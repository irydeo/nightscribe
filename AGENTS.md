...
Toda decisión de arquitectura/diseño está en `docs/adr/` (ADR-000 a ADR-024, bilingües).
...
decisions live in `docs/adr/` (ADR-000 to ADR-024, bilingual). Read the ADR before
